...
class ColorDetection:
    ...
    def getClothingItems(self, img_path):
        ...
        detection_results_folder = os.path.join(self.image_folder, "Test_Image_Detection_Results")
    ...
    def get_image_str(selg, img_path):
    ...
    def getClothingData(self):
        ...
        clothingItemsDF = self.getClothingItems(img_path)
        ...
        returnObj["color_img"] = self.get_image_str(colors_path)
